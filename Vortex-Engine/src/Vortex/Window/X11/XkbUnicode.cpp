...
namespace Vortex
{
    // NOTE(v1tr10l7): source of this code:
    // https://github.com/glfw/glfw/blob/master/src/xkb_unicode.c
    ...
    {
        i32 min = 0;
        i32 max = sizeof(s_KeysymTab) / sizeof(CodePair) - 1;
        ...
        {
            mid = (min + max) / 2;
            if (s_KeysymTab[mid].keysym < keysym) min = mid + 1;
            else if (s_KeysymTab[mid].keysym > keysym) max = mid - 1;
            else return s_KeysymTab[mid].ucs;
        }
