...
//
#ifndef VORTEX_VERTEXBUFFERLAYOUT_HPP
#define VORTEX_VERTEXBUFFERLAYOUT_HPP
...
namespace Vortex::Graphics
{
    ...
    class VertexBufferLayout
    {
        public:
            ...
            VT_NODISCARD inline int32 GetStride() const noexcept { return stride; }
            VT_NODISCARD inline size_t GetElementCount() const noexcept { return elements.size(); }
...
#endif //VORTEX_VERTEXBUFFERLAYOUT_HPP
