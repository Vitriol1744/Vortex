...
namespace Vortex::Renderer2D
{
    ...
    void        Initialize()
    {
        ...
        s_WhiteTexture  = Texture2D::Create("assets/textures/texture.png");
    ...
    void DrawQuad(const Mat4& transform, const Math::Vec4& color)
    {
        ...
        static Math::Vec4 quadVertexPositions[4];
