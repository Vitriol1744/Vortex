...
namespace Vortex
{
    ...
    class VT_API Camera
    {
      public:
        ...
        inline enum ProjectionType ProjectionType() const
        {
            return m_ProjectionType;
        }
        inline const Math::Vec3& Position() const { return m_Position; }
        inline const Quat&       Rotation() const { return m_Rotation; }
        inline const Math::Vec3& Scale() const { return m_Scale; }
        inline const Mat4&       Projection() const { return m_Projection; }
        inline const Mat4&       View()
        {
            Recalculate();
            return m_View;
        }
        inline const Mat4& ViewProjection()
        {
            Recalculate();
