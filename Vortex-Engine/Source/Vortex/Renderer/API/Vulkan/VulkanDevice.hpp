...
namespace Vortex
{
    class VulkanPhysicalDevice final
    {
      public:
        ...
        inline const struct QueueFamilyIndices&
      ...
      private:
        ...
        struct QueueFamilyIndices m_QueueFamilyIndices;
    ...
    class VulkanDevice final
    {
      public:
        ...
        inline const VulkanPhysicalDevice& PhysicalDevice() const
        {
            return m_PhysicalDevice;
        }
        inline                 operator vk::Device() const { return m_Device; }

        inline vk::Queue       GraphicsQueue() const { return m_GraphicsQueue; }
        inline vk::Queue       PresentQueue() const { return m_PresentQueue; }
        inline vk::Queue       ComputeQueue() const { return m_ComputeQueue; }
        inline vk::Queue       TransferQueue() const { return m_TransferQueue; }

        inline vk::CommandPool GraphicsCommandPool() const
        {
            return m_GraphicsPool;
        }
        inline vk::CommandPool TransferCommandPool() const
        {
