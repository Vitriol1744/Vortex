...
namespace Vortex::VulkanAllocator
{
    ...
    void                Initialize()
    {
        ...
        createInfo.vulkanApiVersion
            = VulkanRenderer::VulkanInstance().UsedApiVersion();
        createInfo.physicalDevice
            = vk::PhysicalDevice(VulkanRenderer::PhysicalDevice());
        createInfo.device   = vk::Device(VulkanRenderer::Device());
        createInfo.instance = vk::Instance(VulkanRenderer::VulkanInstance());
