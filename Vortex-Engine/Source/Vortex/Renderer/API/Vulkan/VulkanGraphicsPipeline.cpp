...
namespace Vortex
{
        ...
        const GraphicsPipelineSpecification& specification)
    {
        ...
        vertexShaderStage.module = m_Shader->VertexShader();
        ...
        fragmentShaderStage.module = m_Shader->FragmentShader();
        ...
        bindingDescription.stride    = specification.Layout.Stride();
        bindingDescription.inputRate = vk::VertexInputRate::eVertex;

        Vector<vk::VertexInputAttributeDescription> attributeDescriptions;
        attributeDescriptions.Resize(specification.Layout.ElementCount());
        u32 binding  = 0;
        u32 location = 0;
        ...
        dynamicState.pDynamicStates      = dynamicStates.Raw();

        vk::Device  device               = VulkanRenderer::Device();
        const auto& descriptorSetLayouts = m_Shader->DescriptorSetLayouts();

        vk::PipelineLayoutCreateInfo pipelineLayoutInfo{};
        pipelineLayoutInfo.sType = vk::StructureType::ePipelineLayoutCreateInfo;
        pipelineLayoutInfo.setLayoutCount         = descriptorSetLayouts.Size();
        pipelineLayoutInfo.pSetLayouts            = descriptorSetLayouts.Raw();
        pipelineLayoutInfo.pushConstantRangeCount = 0;

        auto swapChain
            = specification.Window->SwapChain().As<VulkanSwapChain>();
        ...
        auto imageFormat = context->SwapChain().ImageFormat();
