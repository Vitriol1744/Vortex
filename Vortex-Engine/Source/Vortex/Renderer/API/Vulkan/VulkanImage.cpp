...
namespace Vortex
{
    ...
    void VulkanImage::CreateSampler()
    {
        ...
        VkCall(device.createSampler(&samplerInfo, VK_NULL_HANDLE, &m_Sampler));
    }
    ...
    {
        const VulkanDevice& device        = VulkanRenderer::Device();
                                       ...
                                       vk::ImageLayout newLayout, u32 mipLevels)
    {
        ...
        // Default aspect mask configuration
                        ...
                        == vk::ImageLayout::eDepthStencilAttachmentOptimal)
        {
            ...
            VtCoreAssertMsg(
                false,
                "Unsupported Vulkan image layout transition configuration!");
        }
