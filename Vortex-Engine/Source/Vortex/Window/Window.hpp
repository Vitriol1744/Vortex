...
namespace Vortex
{
    ...
    struct WindowSpecification
    {
        ...
        WindowSpecification(const VideoMode& videoMode, StringView title)
            : VideoMode(videoMode)
            , Title(title)
        {
        }
        ...
        String             Title        = "Vortex Application";
    ...
    class VT_API Window : public NonCopyable<Window>
    {
      public:
        ...
        virtual std::any       NativeHandle() const noexcept = 0;
        ...
        virtual String         Title() const noexcept        = 0;
        virtual Math::Vec2i    Position() const noexcept     = 0;
        virtual Math::Vec2i    Size() const noexcept         = 0;
        inline i32             Width() const noexcept { return Size().x; }
        inline i32             Height() const noexcept { return Size().y; }
        virtual Math::Vec2i    FramebufferSize() const noexcept      = 0;
        virtual Math::Vec2f    ContentScale() const noexcept         = 0;
        virtual f32            Opacity() const noexcept              = 0;
        virtual Math::Vec2d    CursorPosition() const noexcept       = 0;

        virtual Ref<SwapChain> SwapChain() const noexcept            = 0;
        ...
        virtual void SetCursorPosition(Math::Vec2d position) noexcept = 0;
        ...
        static Path  OpenFileDialog(PathView initialFolder = ""_sv);
        ...
        static Scope<Window> Create(u32 width, u32 height, StringView title)
        {
        ...
        static WindowSubsystem WindowSubsystem();
      ...
      protected:
        struct WindowData
        {
            ...
            Array<bool, ToUnderlying(Input::KeyCode::eKeyCount)> Keys;
            Array<bool, ToUnderlying(Input::MouseCode::eButtonCount)>
                        MouseButtons;

            Math::Vec2d MousePosition = {0, 0};
        } m_Data;
    };
    ...
    namespace WindowEvents
    {
        ...
        //
        extern Event<Window*, String>              FileDroppedEvent;
